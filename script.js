...
const quizQuestions = [
  ...
  {
    question: "Qual destas opções NÃO é uma linguagem de programação?",
    answers: [
...
function showQuestion() {
  ...
  progressPercent = (currentQuestionIndex / quizQuestions.length) * 100;
...
function showResults() {
  ...
  if (percentage === 100) {
    ...
    resultMessage.textContent = "Excelente trabalho! Você entende do assunto!";
